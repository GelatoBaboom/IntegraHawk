...
Angle Giro::GetAngles()
{
	...
	*/
	...
	//      Serial.print(F("\t Packet corruption"));  // fifoCount / packetSize returns a remainder... Not good! This should never happen if all is well.
	//      mpu.reset();
	//      MPU6050Connect();
	//    }
...
void Giro::i2cSetup() {
	...
	TWBR = 12; // 200kHz I2C clock (100kHz if CPU is 8MHz)
